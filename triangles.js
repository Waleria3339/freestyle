...
function getCards() {
    return triangles = ["7.png", "8.png", "15.png", "20.png", "24.png", "35.png", "44.png", "47.png", "64.png", "pair_7.png", "pair_8.png", "pair_15.png", "pair_20.png", "pair_24.png", "pair_35.png", "pair_44.png", "pair_47.png", "pair_64.png" ]
}
...
function cardsBoarding(){
    ...
    for (let i = 0; i < cards.length; i++) {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            cardDiv.id = "card" + i;
            cardDiv.className = 'memory-card-triangles';
...
function restoreCards(actualCardNumber, visibleCardNumber){
    $('#card' + actualCardNumber).css('background-image', 'url(images/background_5.png)');
    $('#card' + visibleCardNumber).css('background-image', 'url(images/background_5.png)');
    // usuwanie blokady
    lockCards = false;
}

function checkingTwoClicksInOneCard(cardNumber){
    $('#card' + cardNumber).css('background-image', 'url(images/background_5.png)');
    firstVisibleCard = false;
    lockCards = false;
    turnCounter ++;
    $('.score').html('Turn counter: ' + turnCounter);
