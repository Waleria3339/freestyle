...
function getCards() {
    return country = ["australia.png", "brazil.png", "britain.png", "china.png", "france.png", "germany.png", "italy.png", "peru.png", "usa.png", "pair_australia.png", "pair_brazil.png", "pair_britain.png", "pair_china.png", "pair_france.png", "pair_germany.png", "pair_italy.png", "pair_peru.png", "pair_usa.png"]
}
...
function cardsBoarding(){
    ...
    for (let i = 0; i < cards.length; i++) {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            cardDiv.id = "card" + i;
            cardDiv.className = 'memory-card-country';
